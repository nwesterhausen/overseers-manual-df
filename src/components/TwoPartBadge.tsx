...
export type TwoPartBadgeProps = {
	bg: "primary" | "secondary" | "success" | "danger" | "warning" | "info" | "light" | "dark" | "accent" | "ghost" | "neutral";
	name: string;
	value: string;
};
...
const TwoPartBadge: Component<TwoPartBadgeProps> = (props) => {
	...
	return (
		<div class="join">
			...
			{noValue ? <></> : <span class="rounded-s-none text-xs badge badge-secondary font-semibold ps-0.5">{props.value}</span>}
		</div>
	);
};
