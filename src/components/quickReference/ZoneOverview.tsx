		...
		<div class="p-8">
			...
			<article class="min-w-full prose">
				<section>
					...
					<p>
						Meeting area zones are zones in which idle dwarves and animals will congregate. Additionally, immigrants
						will collect at a meeting area until their "migrant" status wears off. Note that the wagon you arrive with
						...
						good idea to have at least one meeting area of one form or another: It allows you to make off-duty dwarves
						and animals gather in an area where they are not vulnerable within the fortress. A meeting area filled with
						dwarves increases the social skills of idlers. It makes idle dwarves a little less idle. Because almost
						every dwarf visits a meeting area at least occasionally, it's an ideal place to site valuable objects and
						buildings. Note that having dwarves socialize will often result in them forming relationships.
					</p>
					<p>Variations:</p>
					<ul>
				...
				<section>
					...
					<p>
						...
						belongings in. Bedrooms are automatically claimed by dwarves (or spouses of dwarves); or they may be
						manually assigned to a dwarf. Once a bedroom has an owner, it becomes the private quarters for that dwarf,
						where they will sleep, store any belongings that are not carried, and hang out in if there is no meeting
						area. Assigning a dwarf a new bedroom will NOT un-assign them from their old bedroom(s); if you want them to
						only have one bedroom, you'll need to track down their old bedroom and un-assign it.
					</p>
					<p>Furniture Requirements (zone will not work without):</p>
					<ul>
						<li>a bed</li>
				...
				<section>
					...
					<p>
						...
						will sleep. Dormitories contribute less to happiness compared to bedrooms, but it is a good practice to have
						a dormitory available for newly arrived migrants. A higher value dormitory will give better thoughts than a
				...
				<section>
					...
					<p>
						A Dining Hall is a zone where dwarves go to eat. The assigned zone may be either assigned to a specific
						dwarf (usually a noble) or designated as a dining hall. A valuable communal dining hall is an excellent way
						to reduce stress.
					</p>
					<p>Furniture Requirements (zone will not work without):</p>
					<ul>
					...
					<p>
						...
						magnificent dining hall (forgoing the positive thought and possibly generating negative thoughts as well).
						To avoid this, do not install tables or chairs in your non-noble dwarves' quarters.
					</p>
				</section>
				<section>
				...
				<section>
					...
					<p>
						...
						buckets of water to make a <em>pond</em>. Creatures can be assigned to a pit/pond. If the creature is caged,
						a dwarf will release it from the cage (rather than bringing the cage to the pit), and then lead the beast to
						the pit and throw it in. The only real difference between a pit and a pond is that dwarves will attempt to
						fill a pond with water, carried by bucket from a <a href="#water-source">water source</a>. Each bucketful
						increases the depth of the water in the tile below by 1/7. Once the water is dumped from the bucket, the
						dwarf will either drop the bucket and perform a different task, or choose to fill a pond zone tile again
						using the bucket (s)he currently holds. Dwarves will stop scheduling the Fill Pond job when the water depth
						reaches 6/7.
					</p>
					...
					<p>
						Specifying a pond zone is one technique used for irrigation, in order to make mud for farming on areas
						without soil. Currently, no matter how large the designated pond area, only one dwarf at a time will try to
						fill the pond. In order to fill a large area quickly, it is necessary to designate multiple smaller pond
						zones (or several zones overlapping the same area).
					</p>
				</section>
				<section>
				...
				<section>
					...
					<p>
						Dwarves that have been assigned to tombs will retain all of their possessions when they die, and other
						dwarves will place them in the tomb - it can be a good idea to keep a chest or cabinet in the tomb to ensure
						that all of the items fit; otherwise, all of the dwarf's possessions will be inherited by their spouse (if
						one exists) or simply become unowned.
					</p>
				</section>
				<section>
					...
					<p>
						...
						dwarf-made), garbage will be thrown into the open space. If a dump is designated over a ramp to the next
						level down, some dwarves may walk down the ramp to dump their items, while others may just toss their items
				...
				<section>
					...
					<p>
						...
						sources - thus, if you want to place a single-tile zone, place the zone onto a ground tile next to the
						water, not over the water itself. This zone should not be used with wells - this is redundant, as they are
						already considered their own water source.
					</p>
				</section>
				<section>
				...
				<section>
					...
					<p>
						A dungeon, also known as a prison, its rooms known as jails, is a zone used by the justice system within
						your dwarven community. As your dwarves break the law, your Sheriff/Captain of the Guard, or any Fortress
						Guard, will place them in one of the designated restraints, dragging their prisoner to the dungeon
						regardless of their strength, or even if they transform into a werebeast halfway there.
					</p>
				...
				<section>
					...
					<p>
						...
						tiles. Far-flung fisherdwarves fishing in a distant river or pool are a serious defensive liability in case
						of an attack, so designating a safer fishing zone and, optionally, restricting non-zone fishing in the
						standing orders menu will help keep your fisherdwarves safe. Dwarves can fish through a grate or even a
						well, provided there is water in the tile 1 z-level below the activity zone.
					</p>
				</section>
				<section>
					<h2 id="gather-fruit">Gather Fruit</h2>
					<p>
						This will automate plant-gathering jobs in this area, necessary if you want your dwarves to collect fruit
						from the floor or trees. If there are fruit-bearing trees in the designated area, a dwarf will fetch a
						stepladder to climb into the tree. The ladder-using dwarf will drop harvested fruit to the ground for others
						to collect and haul. The details can be set in a sub-menu.
					</p>
				</section>
				<section>
				...
				<section>
					...
					<p>
						A clay collection zone allows dwarves with the item hauling labor active to create clay for use in the
						ceramic industry. The 'collect clay' task is created at a kiln.
					</p>
				</section>
			</article>
		</div>
