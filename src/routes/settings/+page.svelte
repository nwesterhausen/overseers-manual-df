...
<div class="py-4">
    <fieldset class="fieldset rounded-box p-2 pt-0 border">
        ...
        <p>
            Set custom locations for where Dwarf Fortress and your data are
            located.
        </p>
    ...
    <fieldset class="fieldset rounded-box border p-2 pt-0">
        ...
        <p>
            Choose what locations to include when parsing the raws. Choosing
            none results in no raws parsed.
        </p>
